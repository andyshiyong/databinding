...
public class MathUtil {
    ...
    public static float parseFloat(String sFloat) {
        float parseFloat = 0;
        try {
            parseFloat = Float.parseFloat(sFloat);
        }catch (Exception e){}
        return parseFloat;
    }
     ...
     * @return
     */
    public static double formatDoubleF(double aDouble,int precision) {
        double result = (double) Math.round(aDouble *Math.pow(10,precision)) / Math.pow(10,precision);
        return result;
    }
    ...
    public static long strToLong(String mLong) {
        try {
            long result=Long.parseLong(mLong);
            return result;
        }catch (Exception e){}
        return 0;
    }

    public static String getCountNameK(int count,String countName) {
        if (count < 1000) {
            return count+"";
        }
        return countName;
